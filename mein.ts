...
type Character = 'Skeleton' | 'Zombie' | 'Warrior' | 'Assassin';


type Action = 'Fight' | 'Run';


const characterHealth: { [key in Character]: number } = {
    Skeleton: 50,
    Zombie: 70,
    Warrior: 100,
    Assassin: 80
...
async function startGame() {
    ...
    let enemy: Character;
    if (character === 'Skeleton') enemy = 'Zombie';
    else if (character === 'Zombie') enemy = 'Skeleton';
    else if (character === 'Warrior') enemy = 'Assassin';
    else enemy = 'Warrior';
